...
public class PanCamera : MonoBehaviour
{
    ...
    {
        // Desktop
        if (Application.platform != RuntimePlatform.Android && Application.platform != RuntimePlatform.IPhonePlayer && Input.mousePresent)
        {
            canUseMouse = true;
        }
    }
    ...
    void OnPinch(Vector2 center, float oldDistance, float newDistance, Vector2 touchDelta)
    {
        ...
        if (controlCamera && cameraControlEnabled)
        {
            ...
            if (cam.orthographic)
            {
                ...
                cam.orthographicSize = Mathf.Min(16, Mathf.Max(1f, cam.orthographicSize * oldDistance / newDistance));
